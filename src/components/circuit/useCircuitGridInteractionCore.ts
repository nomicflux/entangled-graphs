...
import { useCircuitGridPlacementState } from "./useCircuitGridPlacementState";
...
export const useCircuitGridInteractionCore = (options: CircuitGridInteractionOptions = {}) => {
